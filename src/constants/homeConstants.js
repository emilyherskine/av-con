...
export const ACTION_LINKS = [
    { label: "Become a Speaker", to: "/exhibitorRegistration" },
    { label: "Explore Partnerships", to: "/exhibitorRegistration" },
    { label: "Join Industry Network", to: "/avConNetwork" },
];

export const HOME_CONFIG = {
    heroTitle: "Connecting Industry. Inspiring Talent. Shaping Tomorrow's Workforce.",
