    ...
    return (
        <main className="app-page">
            ...
            <section className="pathway-section">
                ...
                <p>
                    Whether you're discovering aviation for the first time,
                    preparing for your career, or looking to develop new skills,
                    A.P.P connects you with opportunities across the aviation,
            ...
            <section className="industry-callout">
                ...
                <h2>
                    Are You an Organisation Offering Opportunities?
                </h2>

                <p>
                    Help shape the next generation of aviation professionals.
                    Share your work experience placements, courses, internships,
                    graduate programmes or training opportunities with the AvCon
                    community.
                </p>
